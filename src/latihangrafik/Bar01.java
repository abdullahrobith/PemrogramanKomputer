...
public class Bar01 {
    ...
    private static CategoryDataset createDataset() {
        ...
        dataset.addValue(6.0, APR, income);
        dataset.addValue(4.0, APR, TRS);
        dataset.addValue(7.0, APR, QTY);
        
        dataset.addValue(5.0, MEI, income);
        dataset.addValue(3.0, MEI, TRS);
        dataset.addValue(6.0, MEI, QTY);
        
        dataset.addValue(4.0, JUN, income);
        dataset.addValue(3.0, JUN, TRS);
        dataset.addValue(5.0, JUN, QTY);
        
        dataset.addValue(3.0, JUL, income);
        dataset.addValue(5.0, JUL, TRS);
        dataset.addValue(6.0, JUL, QTY);
        
        dataset.addValue(5.0, AGU, income);
        dataset.addValue(3.0, AGU, TRS);
        dataset.addValue(4.0, AGU, QTY);
        
        dataset.addValue(3.0, SEP, income);
        dataset.addValue(6.0, SEP, TRS);
        dataset.addValue(5.0, SEP, QTY);
        
        dataset.addValue(4.0, OKT, income);
        dataset.addValue(6.0, OKT, TRS);
        dataset.addValue(7.0, OKT, QTY);
        
        dataset.addValue(4.0, NOV, income);
        dataset.addValue(2.0, NOV, TRS);
        dataset.addValue(5.0, NOV, QTY);
        
        dataset.addValue(6.0, DES, income);
        dataset.addValue(3.0, DES, TRS);
        dataset.addValue(5.0, DES, QTY);
